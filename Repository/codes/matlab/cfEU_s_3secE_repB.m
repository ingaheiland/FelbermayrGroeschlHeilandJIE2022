...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    3 sectors, alternative parameters estimates  BOOTSTRAP   %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Tmat=dlmread('input_3s/bltau_sec-aest.txt');
he = size(Tmat,1);
Tmat = -ones(he,J)./Tmat;
Tmat=Tmat';
...
delta_schengen_mat=dlmread('input_3s/bschengen_sec-aest.txt');
delta_schengen_mat=-delta_schengen_mat'.*Tmat;

delta_Smarket_mat=dlmread('input_3s/bbotheea_sec-aest.txt');
delta_Smarket_mat=-delta_Smarket_mat'.*Tmat;

delta_euro_mat = dlmread('input_3s/bbotheuro_sec-aest.txt');
delta_euro_mat=-delta_euro_mat'.*Tmat;

delta_eukor_mat = dlmread('input_3s/beukor_sec-aest.txt');
delta_eukor_mat=-delta_eukor_mat'.*Tmat;

delta_oRTA_mat = dlmread('input_3s/bbothrta_sec-aest.txt');
...
save 'MATLAB/initial_condition_eu_repsB_3secE'
...
for reps=1:Reps
    ...
    load 'initial_condition_eu_repsB_3secE'
...
load(strcat(workdir,'/Results/allEU_3Esmd/allEU_3Esmd'), 'pf0_all', 'wf0_all')                 %%%%%%%%% ADJUST ME %%%%%%%%
wstart = wf0_all;
pstart = pf0_all;
...
if (reps==1)
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/rva.txt'),RVA)                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/rvap.txt'),RVAp)                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/exf.txt'),EXf)                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/exfp.txt'),EXfp)                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/wr.txt'),wrhat)                  %%%%%%%%% ADJUST ME %%%%%%%%
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/what.txt'),what)                  %%%%%%%%% ADJUST ME %%%%%%%%
end

if (reps>1)
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/rva.txt'),RVA,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/rvap.txt'),RVAp,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/exf.txt'),EXf,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/exfp.txt'),EXfp,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/wr.txt'),wrhat,'-append')                  %%%%%%%%% ADJUST ME %%%%%%%%
dlmwrite(strcat(workdir,'/Results/allEU1000_3EsecB/what.txt'),what,'-append')                  %%%%%%%%% ADJUST ME %%%%%%%%
end
