...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  EU collapse counterfactual  with simplified io coefficients : BOOTSTRAP  %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%          ALL 50 SECTORS
...
load(strcat(workdir,'/Results/allEU_gfake_smdB/allEU_smd'), 'pf0_all', 'wf0_all')                 
wstart = wf0_all;
pstart = pf0_all;
...
if (reps==1)
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/rva.txt'),RVA)                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/rvap.txt'),RVAp)                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/exf.txt'),EXf)                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/exfp.txt'),EXfp)                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/wr.txt'),wrhat)                  
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/what.txt'),what)                  
end

if (reps>1)
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/rva.txt'),RVA,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/rvap.txt'),RVAp,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/exf.txt'),EXf,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/exfp.txt'),EXfp,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/wr.txt'),wrhat,'-append')                  
dlmwrite(strcat(workdir,'/Results/allEU1000_gfake_secB/what.txt'),what,'-append')                  
end
