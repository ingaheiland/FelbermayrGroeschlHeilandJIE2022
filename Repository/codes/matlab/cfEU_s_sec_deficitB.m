% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    Robustness: constant deficit in levels/baseline without deficits: AT MEANS OF ESTIMATED PARAMETERS   %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% ROBUSTNESS: compare old and new algorithm
...
dlmwrite(strcat(workdir,'/Results/allEU_smd_oldB/cf_what.txt'),what)
save(strcat(workdir,'/Results/allEU_smd_oldB/allEU_smd_old'))
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  generate balanced-trade-inventory-free equilibrium with new algorithm %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
clear Dinp_all Fp_all pf0_all PQ_all SIn Sn wf0_all T Ares pihat A
save(strcat(workdir,'/Results/NewBaseline_smd/NewIC_NoSB'))





load(strcat(workdir,'/Results/NewBaseline_smd/NewIC_NoSB'))
...
dlmwrite(strcat(workdir,'/Results/allEU_smd_noSB/cf_what.txt'),what)

save(strcat(workdir,'/Results/allEU_smd_noSB/allEU_smd'))
