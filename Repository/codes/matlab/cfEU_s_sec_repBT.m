...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%    EU collapse scenario with lower bounds of effects: BOOTSTRAP   %
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Tmat=importdata('input/Bdraws/sectoral-trend/bltau-sec-nnew.txt');
Tmat=Tmat.data;
he = size(Tmat,1);
Tmat = -ones(he,J)./Tmat;
Tmat=Tmat';
...
hel=importdata('input/Bdraws/sectoral-trend/bschengen-sec-nnew.txt');
delta_schengen_mat = hel.data;
delta_schengen_mat=-delta_schengen_mat'.*Tmat;

hel=importdata('input/Bdraws/sectoral-trend/bbotheea-sec-nnew.txt');
delta_Smarket_mat = hel.data;
delta_Smarket_mat=-delta_Smarket_mat'.*Tmat;

hel=importdata('input/Bdraws/sectoral-trend/bbotheuro-sec-nnew.txt');
delta_euro_mat = hel.data;
delta_euro_mat=-delta_euro_mat'.*Tmat;

hel=importdata('input/Bdraws/sectoral-trend/beukor-sec-nnew.txt');
delta_eukor_mat = hel.data;
delta_eukor_mat=-delta_eukor_mat'.*Tmat;

hel=importdata('input/Bdraws/sectoral-trend/bbothrta-sec-nnew.txt');
...
save 'MATLAB/initial_condition_eu_repsBT'
...
for reps=1:Reps
    ...
    load 'initial_condition_eu_repsBT'
...
load(strcat(workdir,'/Results/allEU_smdBT/allEU_smd'), 'pf0_all', 'wf0_all')                 %%%%%%%%% ADJUST ME %%%%%%%%
wstart = wf0_all;
pstart = pf0_all;
...
if (reps==1)
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/rva.txt'),RVA)                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/rvap.txt'),RVAp)                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/exf.txt'),EXf)                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/exfp.txt'),EXfp)                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/wr.txt'),wrhat)                 
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/what.txt'),what)                
end

if (reps>1)
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/rva.txt'),RVA,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/rvap.txt'),RVAp,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/exf.txt'),EXf,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/exfp.txt'),EXfp,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/wr.txt'),wrhat,'-append')                
dlmwrite(strcat(workdir,'/Results/allEU1000_secBT/what.txt'),what,'-append')                 
end
